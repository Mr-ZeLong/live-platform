...
public class LiveCurrencyAccountServiceImpl implements ILiveCurrencyAccountService {
    ...
    public boolean insertOne(Long userId) {
        try {
            LiveCurrencyAccountPO accountPO = new LiveCurrencyAccountPO();
            accountPO.setUserId(userId);
            liveCurrencyAccountMapper.insert(accountPO);
            return true;
        } catch (Exception e) {
    ...
    public LiveCurrencyAccountDTO getByUserId(Long userId) {
        return ConvertBeanUtils.convert(liveCurrencyAccountMapper.selectById(userId), LiveCurrencyAccountDTO.class);
    }
    ...
    public Integer getBalance(Long userId) {
        ...
        balance = liveCurrencyAccountMapper.queryBalance(userId);
        if (balance == null) {
...
//    }
    ...
    public AccountTradeRespDTO consume(AccountTradeReqDTO accountTradeReqDTO) {
        Long userId = accountTradeReqDTO.getUserId();
        int num = accountTradeReqDTO.getNum();
        LiveCurrencyAccountDTO accountDTO = this.getByUserId(userId);
